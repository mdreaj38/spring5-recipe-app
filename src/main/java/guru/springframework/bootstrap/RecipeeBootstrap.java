 ...
 */
@Component
public class RecipeeBootstrap implements ApplicationListener<ContextRefreshedEvent> {

    private final UnitOfMeasureRepository unitOfMeasureRepository;
    private final CategoryRepository categoryRepository;
    private final RecipeeRepositoriy recipeeRepositoriy;

    public RecipeeBootstrap(UnitOfMeasureRepository unitOfMeasureRepository, CategoryRepository categoryRepository, RecipeeRepositoriy recipeeRepositoriy) {
        this.unitOfMeasureRepository = unitOfMeasureRepository;
        this.categoryRepository = categoryRepository;
        this.recipeeRepositoriy = recipeeRepositoriy;
    }

    private List<Recipee> getRecipee() {
        List<Recipee> recipes = new ArrayList<>(2);
        ...
        //Yummy Guac
        Recipee guacRecipe = new Recipee();
        ...
        guacNotes.setRecipeeNotes("For a very quick guacamole just take a 1/4 cup of salsa and mix it in with your mashed avocados.\n" +
        ...
        guacNotes.setRecipee(guacRecipe);
        ...
        //Yummy Tacos
        Recipee tacosRecipe = new Recipee();
        ...
        tacoNotes.setRecipeeNotes("We have a family motto and it is this: Everything goes better in a tortilla.\n" +
        ...
        tacoNotes.setRecipee(tacosRecipe);
    ...
    public void onApplicationEvent(ContextRefreshedEvent contextRefreshedEvent) {
        recipeeRepositoriy.saveAll(getRecipee());
    }
}